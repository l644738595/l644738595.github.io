...
6. 方法
   1. 改变自身值的方法(9个)
      ...
      5. sort
         1. [使用映射改善排序](#使用映射改善排序)
         2. [奇怪的chrome](#奇怪的chrome)
         3. [问题分析](#问题分析)
      6. [splice](#splice)
      7. [unshift](#unshift)
      8. [copyWithin(ES6)](#copyWithin-ES6)
      9. [fill(ES6)](#fill-ES6)
   2. 不会改变自身的方法(9个)
      1. [concat](#concat)
      2. [join](#join)
      3. [slice](#slice)
      4. [toString](#toString-NaN)
      5. [toLocaleString](#toLocaleString-NaN)
      6. [indexOf](#indexOf)
      7. [lastIndexOf](#lastIndexOf)
      8. [includes(ES7)](#includes-ES7)
      9. [toSource(非标准)](#toSource-非标准)
   3. 遍历方法(12个)
      1. [forEach](#forEach)
      2. [every](#every)
      3. [some](#some)
      ...
      5. [map](#map)
      6. [reduce](#reduce)
      7. [reduceRight](#reduceRight)
      8. [entries(ES6)](#entries-ES6)
      9. [find&findIndex(ES6)](#find-amp-findIndex-ES6)
      10. [keys(ES6)](#keys-ES6)
      11. [values(ES6)](#values-ES6)
      12. [Symbol.iterator(ES6)](#Symbol-iterator-ES6)
7. [小结](#小结)
...
<div id="Array构造器" tabindex="-1"></div>
...
<div id="Array-of" tabindex="-1"></div>
...
<div id="Array-from" tabindex="-1"></div>
...
[![Array.from执行结果](../assets/update/2017/09/05/array01.png)](../assets/update/2017/09/05/array01.png)
...
<div id="Array-isArray" tabindex="-1"></div>
...
<div id="使用映射改善排序" tabindex="-1"></div>
...
<div id="奇怪的chrome" tabindex="-1"></div>
...
<div id="copyWithin" tabindex="-1"></div>
...
<div id="toString" tabindex="-1"></div>
...
<div id="toLocaleString" tabindex="-1"></div>
...
<div id="lastIndexOf" tabindex="-1"></div>
...
<div id="includes-ES7" tabindex="-1"></div>
...
<div id="toSource-非标准" tabindex="-1"></div>
...
<div id="reduceRight" tabindex="-1"></div>
...
<div id="entries-ES6" tabindex="-1"></div>
...
<div id="find-amp-findIndex-ES6" tabindex="-1"></div>
...
<div id="keys-ES6" tabindex="-1"></div>
...
<div id="values-ES6" tabindex="-1"></div>
...
<div id="Symbol-iterator-ES6" tabindex="-1"></div>
...
| Browser       | Chrome | Firefox (Gecko)                          | Internet Explorer | Opera | Safari |
| ------------- | ------ | ---------------------------------------- | ----------------- | ----- | ------ |
| Basic support | 38     | [36](https://developer.mozilla.org/en-US/Firefox/Releases/36) (36) [1](#respond) | 未实现               | 25    | 未实现    |

<div id="小结" tabindex="-1"></div>
